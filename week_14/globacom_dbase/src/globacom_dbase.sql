...
CREATE TABLE public.department (
    ...
    dept_location character(20) NOT NULL,
...
CREATE TABLE public.project (
    project_number integer NOT NULL,
    project_name character(5) NOT NULL,
...
110	Musta Karim         	35	m_karim@gmail.com	0805089112	102	3
111	Lilian Jaiya        	43	l_jaiya@gmail.com	08055185341	100	5
...
116	Adams Bree          	33	a_bree@gmail.com	08056765424	102	10
...
COPY public.department (dept_manager_id, department_number, dept_name, dept_location, project_number) FROM stdin;
...
COPY public.project (project_number, project_name, project_duration, project_managerid) FROM stdin;
11	A    	9 Months	102
22	B    	14 Months	97
33	C    	16 Months	120
44	D    	25 Months	108
...
COPY public.staff (staff_id, staff_name, department_number, staff_sal, age, mobile) FROM stdin;
